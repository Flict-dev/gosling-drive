...
class UploadSessionModel(Base):
    ...
    bucket: Mapped[str] = mapped_column(String(255), nullable=False)
    object_key: Mapped[str] = mapped_column(String(1024), nullable=False)
    target_version_number: Mapped[int] = mapped_column(Integer, default=1, nullable=False)
    target_content_type: Mapped[str] = mapped_column(String(255), nullable=False)
    target_size_bytes: Mapped[int] = mapped_column(BigInteger, nullable=False)
    target_checksum_sha256: Mapped[str] = mapped_column(String(64), nullable=True)
